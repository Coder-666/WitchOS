...
{
    /* == WitchOS Console StdOut Info
     * 
     * printf supports the following replacements:
     *   %c = byte, char
     *   %s = string
     *   %i = byte, short, ushort, int, uint, UInt16, UInt32, UInt64
     *   %d = single, double, float, long, ulong
     *   %f = single, double, float, long, ulong
     *   %% = percent (%-char)
     *   
     * == WitchOS Console StdOut Info End */
